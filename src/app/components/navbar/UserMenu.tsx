...
export default function UserMenu({ currentUser }: UserMenuProps) {
  ...
  const toggleMenu = useCallback(() => setIsOpen((prevValue) => !prevValue), []);
        ...
        >
          {currentUser ? (
            <ul>
              <MenuItem
                label="My trips"
                onClick={() => handleMenuItemClick(() => router.push(ROUTES.TRIPS))}
              />
              <MenuItem
                label="My favorites"
                onClick={() => handleMenuItemClick(() => router.push(ROUTES.FAVORITES))}
              />
              <MenuItem
                label="My reservations"
                onClick={() => handleMenuItemClick(() => router.push(ROUTES.RESERVATIONS))}
              />
              <MenuItem
                label="My properties"
                onClick={() => handleMenuItemClick(() => router.push(ROUTES.MY_PROPERTIES))}
              />
              <MenuItem
                label="New property"
